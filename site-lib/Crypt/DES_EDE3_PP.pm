# $Id: DES_EDE3.pm,v 1.2 2016/04/08 03:41:09 btrott Exp $

package Crypt::DES_EDE3_PP;
use strict;
...
sub init {
    ...
    my($key) = @_;
    for my $i (1..3) {
        $ede3->{"des$i"} = Crypt::DES_PP->new(substr $key, 8*($i-1), 8);
    }
    $ede3;
}
...
Crypt::DES_EDE3_PP - Triple-DES EDE encryption/decryption

=head1 SYNOPSIS

    use Crypt::DES_EDE3_PP;
    my $ede3 = Crypt::DES_EDE3_PP->new($key);
    $ede3->encrypt($block);

=head1 DESCRIPTION

I<Crypt::DES_EDE3_PP> implements DES-EDE3 encryption. This is triple-DES
encryption where an encrypt operation is encrypt-decrypt-encrypt, and
decrypt is decrypt-encrypt-decrypt. This implementation uses I<Crypt::DES_PP>
...
=head2 $ede3 = Crypt::DES_EDE3_PP->new($key)

Creates a new I<Crypt::DES_EDE3_PP> object (really, a collection of three DES
...
Crypt::DES_EDE3_PP is free software; you may redistribute it and/or modify
it under the same terms as Perl itself.

=head1 AUTHOR & COPYRIGHTS

Crypt::DES_EDE3_PP is Copyright 2001 Benjamin Trott, ben@rhumba.pair.com. All
rights reserved.
